...
WalkSpeedSec:NewButton("Infjump", "Jump Forever", function()
...
WalkSpeedSec:NewButton("Noclip GUI", "go to backrooms", function()
...
WalkSpeedSec:NewButton("Rejoin Game", "", function()
